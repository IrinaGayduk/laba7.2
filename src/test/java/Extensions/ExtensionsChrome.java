...
import java.util.*;
public class ExtensionsChrome extends ChromeDriver {
    public ExtensionsChrome() throws Exception {
        this(new ChromeOptions());
    }

    public ExtensionsChrome(ChromeOptions options) throws Exception {
        this(ChromeDriverService.createDefaultService(), options);
    }

    public ExtensionsChrome(ChromeDriverService service, ChromeOptions options) throws Exception {
